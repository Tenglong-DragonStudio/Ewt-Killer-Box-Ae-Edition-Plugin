...
export class CourseListView extends View {
    loading: boolean;
    prog?:ProgressBar
    ...
    async onCreate() {
        ...
        this.mission = new MissionService(user,parseInt(this.homeworkId))
    }
    ...
    async surfaceComponent(): Promise<JQuery<HTMLElement>> {
        ...
        right.append(this.HeadComponent(data.homeworkTitle,data.startDate,data.endDate,prog))
        ...
        right.append(selection_comp.getPage())
        right.append(warn)
        right.append(foot)
